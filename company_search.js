// 회사 이름 검색 (공정위 2026 공시대상기업집단 소속회사 중 자산총액 5,000억 원 이상 696개사)
...
(function () {
  ...
  const MSG = collab ? {
    ...
    none: '<b>목록에서 찾지 못했습니다.</b><br>회사 이름을 짧게 줄여 다시 검색해 보세요(예: \'삼성전자\' → \'삼성\'). ' +
          '그래도 없지만 대기업 계열사라면 응답할 때 회사 목록에서 \'기타\'를 고르고 회사명을 적으면 됩니다.',
  } : {
    label: '회사 이름으로 검색',
    ok: '<b>✔ 설문 대상 회사입니다.</b> 설문 첫 부분의 회사 목록에서 다니시는 회사를 골라 주세요.',
    none: '<b>목록에서 찾지 못했습니다.</b><br>회사 이름을 짧게 줄여 다시 검색해 보세요(예: \'삼성전자\' → \'삼성\'). ' +
          '그래도 없지만 대기업 계열사라고 생각되시면 응답해 주시고, 설문의 회사 목록에서 \'기타\'를 고른 뒤 회사명을 적어 주세요.',
  };
